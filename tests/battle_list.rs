...
#[test]
fn should_get_creatures_count_return_0_when_there_are_no_creatures() {
...
#[test]
fn should_get_creatures_count_return_45_when_its_full_of_creatures() {
...
#[test]
fn should_get_max_creatures_count_return_45() {
    let content = load_image("./assets/examples/client/battle_list/full_of_creatures.png").unwrap();
    let battle_list = BattleList { content };
...
#[test]
fn should_has_creature_in_target_return_false_when_there_are_no_creatures() {
    let content = load_image("./assets/examples/client/battle_list/no_creatures.png").unwrap();
    let battle_list = BattleList { content };
...
#[test]
fn should_has_creature_in_target_return_false_when_has_no_creature_in_target() {
    let content = load_image("./assets/examples/client/battle_list/full_of_creatures.png").unwrap();
    let battle_list = BattleList { content };
    assert_eq!(battle_list.has_creature_in_target(), false);
}
...
#[test]
fn should_has_creature_in_target_return_true_when_has_creature_target_in_first_position() {
    let content =
...
#[test]
fn should_has_creature_in_target_return_true_when_has_creature_target_in_last_position() {
    let content =
        load_image("./assets/examples/client/battle_list/target_in_last_position.png").unwrap();
    let battle_list = BattleList { content };
    assert_eq!(battle_list.has_creature_in_target(), true);
}
