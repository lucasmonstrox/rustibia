...
fn benchmark_has_creature_in_target_when_target_is_in_first_position(c: &mut Criterion) {
    let content =
...
fn benchmark_has_creature_in_target_when_target_is_in_last_position(c: &mut Criterion) {
    let content =
...
criterion_group!(
    benches,
    benchmark_get_creatures_count_when_there_are_no_creatures,
    benchmark_get_creatures_count_when_its_full_of_creatures,
    ...
    benchmark_has_creature_in_target_when_target_is_in_first_position,
    benchmark_has_creature_in_target_when_target_is_in_last_position
);
